...
作为一系列计算机科学论文的作者，Dijkstra 是着名（臭名昭着）的。 有些比如“反对 GOTO 语句的案例”（A Case against the GO TO Statement），对编程实践产生了深远的影响。其他比如“真正的计算机科学教学的残酷”（On the Cruelty of Really Teaching Computing Science）的人，很有娱乐性，但效果却不好。
